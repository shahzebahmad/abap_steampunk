*"* use this source file for your ABAP unit test classes
    ...
    CLASS ltcl_integration_test IMPLEMENTATION.
     ...
     METHOD create_travel.
      ...
      DATA travels_in TYPE TABLE FOR CREATE zum_i_travel\\travel.
      ...
      MODIFY ENTITIES OF zum_i_travel
        ENTITY travel
      ...
      SELECT * FROM zum_i_travel WHERE TravelId = @new_travel_id INTO TABLE @DATA(lt_travel)  .
    ...
    METHOD class_setup.
      cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
          i_for_entities = VALUE #( ( i_for_entity = 'zum_i_travel' )
                                  ( i_for_entity = 'zum_i_booking' ) )
                                ).
    ENDMETHOD.
